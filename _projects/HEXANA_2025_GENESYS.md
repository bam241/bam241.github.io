...
short_description: "I rewrote Hexana’s modular reactor geometry module for its Gen IV small modular fast reactor, rooted in CEA heritage, with a clean, fully tool-agnostic core and optional OpenMC export. Backed by strong typing, schema-validated models, extensible interfaces, and a 100% coverage test suite, the pipeline is performant, maintainable, and CI/CD-ready to support flexible, safety-optimized design."
